...
import { Heatmap, HeatmapData, createCalendarTheme } from 'react-github-heatmap';
...
export default function GitHubChart() {
    ...
    useEffect(() => {
        async function loadHeatmap() {
            try {
                ...
                if (!json.heatmapData || !Array.isArray(json.heatmapData.contributions)) {
    ...
    if (!data) {
        return <p className="font-mono text-sm text-muted-foreground">Loading GitHub activity...</p>;
    }
